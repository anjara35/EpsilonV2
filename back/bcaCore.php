...
function displayCoursesList($accessCodeArrayed){
    ...
    echo '<ul id="parcours-list">
        <li><strong>'.$course0.' : </strong>'.numberToRankNamed($accessCodeArrayed[0]).displayCourseLink(0,$accessCodeArrayed).' <span class="see"><i class="fas fa-eye"></i> <a href="fileListing.php?course=0">Voir</a></span></li>'; 
    echo '<li><strong>'.$course1.' : </strong>'.numberToRankNamed($accessCodeArrayed[1]).displayCourseLink(1,$accessCodeArrayed).' <span class="see"><i class="fas fa-eye"></i> <a href="fileListing.php?course=1">Voir</a></span></li>';
    echo '<li><strong>'.$course2.' : </strong>'.numberToRankNamed($accessCodeArrayed[2]).displayCourseLink(2,$accessCodeArrayed).' <span class="see"><i class="fas fa-eye"></i> <a href="fileListing.php?course=2">Voir</a></span></li>';
    echo '<li><strong>'.$course3.' : </strong>'.numberToRankNamed($accessCodeArrayed[3]).displayCourseLink(3,$accessCodeArrayed).' <span class="see"><i class="fas fa-eye"></i> <a href="fileListing.php?course=3">Voir</a></span></li>
    </ul>';
}
